...
import CodeFileUpload from "@/components/CodeFileUpload";
import CodeContextDisplay from "@/components/CodeContextDisplay";
import {
  generateTestsStream,
  getFormats,
  PipelineStage,
...
export default function GeneratePage() {
  ...
  }, [input, existingTests, selectedFormats, codeFiles]);
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Paste your API requirements below — structured or natural language.
            MindFlayer will analyze, plan, and generate tests in multiple
            formats.
          </p>
        </div>
                  ...
                  <div className={styles.scenarioGrid}>
                    {result.test_plan.scenarios.map((scenario) => (
                      <div
                        ...
                        className={`glass-card ${styles.scenarioCard}`}
                      >
                        <div className={styles.scenarioHeader}>
                          <code className={styles.scenarioName}>
                            {scenario.test_name}
                          </code>
                          <span
                            className={`badge ${
                              scenario.test_type === "positive"
                                ? "badge-green"
                                : scenario.test_type === "no_auth"
                                  ? "badge-red"
                                  : scenario.test_type === "dependency_failure"
                                    ? "badge-yellow"
                                    : "badge-purple"
                            }`}
                          >
