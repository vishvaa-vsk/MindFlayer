...
import { Code, Envelope, TestTube, Plant, ClipboardText, Brain, ChartBar, ListBullets, ChatText } from '@phosphor-icons/react';
                    ...
                    <div className={styles.inputHeader}>
                        ...
                        <div className={styles.examples}>
                            <button className="btn btn-ghost" onClick={() => loadExample('structured')}>
                                <ListBullets size={18} weight="duotone" /> Structured Example
                            </button>
                            <button className="btn btn-ghost" onClick={() => loadExample('prose')}>
                                <ChatText size={18} weight="duotone" /> Prose Example
                            </button>
                        </div>
                    </div>
                    <textarea
                    ...
                    <div className={styles.formatSelector}>
                        ...
                        <div className={styles.formatGrid}>
                            {Object.entries(availableFormats).map(([key, format]) => {
                                const IconComponent = FORMAT_ICONS[key] || ClipboardText;
                                return (
                                <button
                                    key={key}
                                ...
                                >
                                    <span className={styles.formatIcon}><IconComponent size={20} weight="duotone" /></span>
                ...
                {result && (
                    <div className={styles.results}>
                        ...
                        <div className={styles.tabs}>
                            {outputTabs.map((fmt) => {
                                const IconComponent = FORMAT_ICONS[fmt] || ClipboardText;
                                return (
                                <button
                                    key={fmt}
                                ...
                                >
                                    <IconComponent size={18} weight="duotone" /> {availableFormats[fmt]?.name || fmt}
                                </button>
                            );})}
                            <button
